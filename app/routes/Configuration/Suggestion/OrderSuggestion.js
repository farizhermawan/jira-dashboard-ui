...
import {CardBody, Col, Container, Fade, Form, Row, UncontrolledTooltip} from "reactstrap";
...
const OrderSuggestion = (props) => {
  ...
  const save = (e) => {
    ...
    let restApiCall = DataService.put('/v1/suggestion-groups/' + group, payload);
  ...
  return (
    <Container>
      ...
      <Fade in={true}>
        <BasicHeader title={toTitle(group)} toolbar={(
          <ButtonToolbar>
