    ...
    <React.Fragment>
      {
        items.length === 0
          ...
          <tr key={index}>
            ...
            <td className="align-middle text-right">{timeFriendly(item.original_estimate)}</td>
            <td className="align-middle text-right">{timeFriendly(item.remaining_estimate)}</td>
            <td className="align-middle text-right">{timeFriendly(item.time_spent)}</td>
...
export default TableBodySubTasks;
