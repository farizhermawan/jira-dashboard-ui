    ...
    <div className="d-flex flex-column flex-md-row mb-3 mb-md-0">
      ...
      <ButtonToolbar>
        <ButtonGroup className="mr-auto mr-md-2">
          <Button tag={NavLink} to={`${props.linkList}`} color="secondary" outline className="align-self-center"
                  id="tooltipShowList">
          ...
          <Button tag={NavLink} to={`${props.linkGrid}`} color="secondary" outline className="align-self-center"
                  id="tooltipShowGrid">
          ...
          </UncontrolledTooltip>
          {
            props.btnShowKanban && (
              <React.Fragment>
                <Button tag={NavLink} to={`${props.linkKanban}`} color="secondary" outline className="align-self-center"
        ...
        <ButtonGroup>
          <Button color="info" className="align-self-center" id="tooltipAddNew">
